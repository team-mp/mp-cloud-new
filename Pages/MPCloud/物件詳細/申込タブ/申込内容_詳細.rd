{
  ...
  "Formulas": {
    ...
    "52,90": "IFERROR(ODATA(\"m_product?$select=housing_type&$filter=product_id eq \"&IF(ISBLANK(CC53),\"null\",CC53)),\"\")",
    "64,80": "IF(AND(OR(元_保証確認区分>0,CC53<>元_受付商品ID),CC53<>\"\",DZ6=1,EA6=1,CI65=0,CO65=0),1,0)",
