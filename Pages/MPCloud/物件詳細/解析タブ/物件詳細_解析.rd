{
  ...
  "RowCount": 72,
  "Formulas": {
    "32,176": "SUM(FP33:FT33)",
    "32,175": "IF(FI33<>FO33,1,0)",
    "32,174": "IF(FH33<>FN33,1,0)",
    "32,173": "IF(FM33<>DV33,1,0)",
    "32,172": "IF(FF33<>FL33,1,0)",
    "37,80": "COUNT(CE33)",
    "32,83": "$CC$38-ROW(CC33)+1",
    "32,171": "IF(FK33<>DN33,1,0)",
    "15,11": "DC22",
    "15,57": "CF22",
    "32,153": "IF(AND(DZ33=0,ED33=1),CI41,\"\")",
    "32,151": "IF(OR(EB33=1,DY33=1,EA33=1,DZ33=1),1,0)",
    "6,101": "IF(OR(CC7=1,CJ7=1,CQ7=1),1,0)",
    "15,41": "CE22",
    "15,29": "CD22",
    "32,150": "IF(ET33<>\"\",\"最終更新日時：\"&ET33,\"\")",
    "32,144": "\"解析ファイル(\"&EN33&\")\"",
    "17,28": "DD22",
    "19,22": "DE22",
    "19,57": "DF22",
    "19,63": "DG22",
    "19,69": "DH22",
    "32,143": "IFERROR(ODATA(\"v_analysis_file_count?$select=ファイル数&$filter=解析ID eq \"&IF(ISBLANK(CE33),\"null\",CE33)),0)",
    "32,142": "調査データ添付フラグ",
    "32,141": "工事見積不要フラグ",
    "32,140": "改良判定時基礎図必要フラグ",
    "32,139": "沈下量検討書必要フラグ",
    "37,172": "IF(SUM(FU33)>0,1,0)",
    "32,122": "IF(DQ33<>\"\",DR33,\"\")"
  },
  "ArrayFormulas": {
